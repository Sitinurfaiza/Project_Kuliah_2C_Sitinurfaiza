                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-floating mb-3" name="no hp">
                                                <input type="number" class="form-control" id="floatingInput" placeholder="08xxxxx" name="no hp">
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                                    ...
                                    <form action="">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="form-floating mb-3" name="no hp">
                                                    <input disabled type="number" class="form-control" id="floatingInput" placeholder="08xxxxx" name="no hp" value="<?php echo $row['no hp'] ?>">
                                                    <label for="floatingInput">No HP</label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <form action="">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="form-floating mb-3" name="no hp">
                                                    <input type="number" class="form-control" id="floatingInput" placeholder="08xxxxx" name="no hp" value="<?php echo $row['no hp'] ?>">
                                                    <label for="floatingInput">No HP</label>
                                                </div>
                                            </div>
                                        </div>
