                ...
                foreach ($result as $row) { ?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="form-floating mb-3">
                                                    ...
                                                    <label for="menu" for="uploadFoto">Kategori</label>
                    ...
                    <div class="modal fade" id="siapsaji<?php echo $row['id_list_order'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Siap Cuci</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate action="proses/proses_siapsaji_orderitem.php" method="POST">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="submit" class="btn btn-primary" name="siapsaji_orderitem_validate" value="12345">Siap Cuci</button>
                                        </div>
                                    </form>
                                </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        if ($row['status']==1){
                                            echo "<span class='badge text-bg-warning'>Sedang Dicuci</span>";
                                        }elseif ($row['status']==2){
                                            echo "<span class='badge text-bg-primary'>Siap Cuci</span>";
                                        }
                                        ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <button class="<?php echo (empty($row['status'])||$row['status']!=1) ? "btn btn-secondary btn-sm me-1 disabled text-nowrap" : "btn btn-success btn-sm me-1"; ?>" data-bs-toggle="modal" data-bs-target="#siapsaji<?php echo $row['id_list_order'] ?>">Siap Cuci</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
